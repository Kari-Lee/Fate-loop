  ...
  return (
    <div className="text-center my-4">
      <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-[13px] cursor-pointer"
        ...
        onClick={() => {
          if (navigator.share) navigator.share({ title: "FateLoop", url: "https://fateloop.app" }).catch(() => {});
          else if (navigator.clipboard) navigator.clipboard.writeText("https://fateloop.app").then(() => alert(t("share.copied")));
        }}>{t("share.button")}</div>
