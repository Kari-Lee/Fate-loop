...
export default function SplashScreen({ onDone }) {
  ...
  return (
    <div style={{
      ...
      background: "radial-gradient(ellipse 80% 60% at 20% 20%, rgba(120, 90, 180, 0.35) 0%, transparent 50%), radial-gradient(ellipse 70% 50% at 80% 30%, rgba(180, 120, 90, 0.25) 0%, transparent 55%), radial-gradient(ellipse 90% 70% at 50% 90%, rgba(60, 80, 140, 0.4) 0%, transparent 60%), linear-gradient(180deg, #0A0612 0%, #050A18 50%, #07050F 100%)",
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 6, marginTop: 16 }}>
          {[0, 1, 2].map((i) => (
            <div key={i} style={{
              ...
              background: "#D4B07A",
              animation: "splash_dot 1.4s eas
cd ~/Downloads/fateloop
cat > src/components/SplashScreen.jsx << 'FLEOF'
import { useState, useEffect } from "react";
