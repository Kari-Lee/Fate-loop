...
export default function Layout() {
  ...
  return (
    <div style={{ background: "#050505", minHeight: "100vh", position: "relative", overflow: "hidden", color: "#FFF" }}>
      ...
      {/* Stars - simple fixed opacity, no CSS var animation */}
      <div style={{ position: "fixed", inset: 0, pointerEvents: "none", zIndex: 1 }}>
        <div style={{ position: "absolute", top: "12%", right: "7%" }}><Star size={28} color={red} filled={true} opacity={0.1} /></div>
        <div style={{ position: "absolute", top: "55%", left: "3%" }}><Star size={18} color={red} filled={true} opacity={0.06} /></div>
        <div style={{ position: "absolute", bottom: "18%", right: "5%" }}><Star size={14} color={red} filled={true} opacity={0.05} /></div>
      </div>

      <header style={{ position: "sticky", top: 0, zIndex: 50, background: "rgba(5,5,5,.7)", backdropFilter: "blur(32px) saturate(1.2)", WebkitBackdropFilter: "blur(32px) saturate(1.2)", borderBottom: "1px solid rgba(255,255,255,.03)" }}>
        <div style={{ maxWidth: 640, margin: "0 auto", padding: "18px 36px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div onClick={() => navigate("/")} style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }}>
            <Star size={11} color={red} filled={true} opacity={0.6} />
            <span style={{ fontSize: 15, fontWeight: 600, color: "#FFF", letterSpacing: 1.5 }}>FateLoop</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            {!isHome && <span onClick={() => navigate("/")} style={{ fontSize: 12, color: "#444", cursor: "pointer" }}>Home</span>}
      ...
      <footer style={{ borderTop: "1px solid rgba(255,255,255,.02)", marginTop: 48, background: "rgba(5,5,5,.5)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", position: "relative", zIndex: 4 }}>
        <div style={{ maxWidth: 640, margin: "0 auto", padding: "28px 36px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <Star size={6} color={red} filled={true} opacity={0.2} />
